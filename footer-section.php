        ...
        <div class="row">
            <div class=" mx-auto text-center">
                ...
                <!-- <p>
                    ...
                    conceptualizing and delivering elegant,
                    user-friendly solutions effectively and
                    efficiently. Possesses a track record of
            ...
            <!-- <div class="col-lg-3 col-sm-12">
                    <form class="form-col" action="contact-config.php" method="POST">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="text-left">
                                <button type="submit" class="footer-btn" >Sent</button>
                            </div>
                        </div>
                    </form>
                </div> -->
